      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <Link href="/">
              <span className="block mb-8">
                <span className="block font-serif text-3xl tracking-widest font-bold text-primary">LOHAGARH</span>
                <span className="block text-[0.6rem] tracking-[0.4em] uppercase text-[#E8611A] mt-1">Group of Hotels</span>
              </span>
            </Link>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 border border-primary/30 rounded-full flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white transition-colors">
                <Instagram size={18} />
              </a>
              <a href="#" className="w-10 h-10 border border-primary/30 rounded-full flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white transition-colors">
                <Facebook size={18} />
          ...
          <div>
            ...
            <p className="text-white/50 text-sm mb-6">Subscribe to receive exclusive offers and updates.</p>
            <div className="flex border-b border-primary/30 pb-2">
              ...
              />
              <button className="text-[#E8611A] text-xs font-bold tracking-widest uppercase hover:text-primary transition-colors">
                Submit
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-primary/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-white/40">
