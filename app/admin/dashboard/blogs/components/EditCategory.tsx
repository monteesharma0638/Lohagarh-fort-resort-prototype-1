...
export default function EditCategory({ category }: { category: any }) {
  ...
  async function handleAddCategory(e: React.SubmitEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await fetch("/api/categories/update", requestOptions)
        ...
        <form onSubmit={handleAddCategory}>
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input name="name" defaultValue={category.name} placeholder="e.g. Travel Destinations" />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-2">
              ...
              <Input name="image" defaultValue={category.image} placeholder="https://..." />
            </div>
          </div>
          <DialogFooter>
