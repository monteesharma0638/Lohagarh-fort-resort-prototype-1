      ...
      <div className="relative h-[60vh] flex items-center justify-center bg-secondary/30">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <MotionDiv initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <span className="block text-sm tracking-[0.3em] uppercase mb-4 text-primary">A Visual Journey</span>
            <h1 className="text-5xl md:text-8xl font-serif">Gallery</h1>
          </MotionDiv>
        </div>
      </div>
      <section className="py-24 container mx-auto px-6 max-w-5xl">
        <SectionHeading title="Our Properties" subtitle="Through the Lens" />
        <p className="text-gray-400 text-lg leading-relaxed text-center max-w-3xl mx-auto">
          Explore the grandeur of our heritage properties through stunning imagery capturing the essence of royal Indian hospitality.
        </p>
      </section>
    </div>
  );
